...
class _AddPageState extends State<AddPage> {
  ...
  final TextEditingController _kullaniciyorumuController =
  ...
  final List<Map<String, dynamic>> dataList = [
    ...
    },
    {
      ...
      "name": "aslanbaligi",
      "detay":
          "Aslan balığı, Hint Okyanusu ve Büyük Okyanus'un batı kısımlarında, Kızıldenizde, mercan kayalıklarda yaşayan zehirli deniz balıklarından oluşan bir cinstir. İnsanlar için tehlike teşkil ederler. Kıyıya yakın yerler ile 50 metre derinlik arasındaki kısımlarda yaşarlar. Yetişkinleri 40 cm uzunluğa değin erişebilirler."
    },
    {
      "id": 2,
      "name": "balonbaligi",
      "detay":
          "Balon balığı veya Sennin-fugu olarak bilinen Lagocephalus sceleratus, Tetraodontidae familyasından son derece zehirli bir kemikli deniz balığıdır."
    },
    {
      "id": 3,
      "name": "barbun",
    ...
    },
    {
      ...
      "name": "hamsi",
      "detay":
          "Sürüler halinde yaşar ve 18 cm'e kadar büyür. Ocak - Mart arasında beslenmek için sahillere yaklaşır. Gündüzleri 30–40 m. derinlerde, geceleri yüzeye yakınlarda dolaşır. 1 yaşından itibaren olgunluğa erişip 18°-20 °C sularda, 25–60 m. derinliklerde ve az tuzlu sularda üreyip yaklaşık 40.000 yumurta döker."
    },
    {
      "id": 6,
      "name": "iskorpit",
    ...
    },
    {
      ...
      "name": "istavrit",
      "detay":
          "İstavrit, Carangidae familyasından Trachurus cinsini oluşturan balık türlerine verilen ad. Birbirine çok benzeyen bu balıkların vücudu yanlardan biraz basık ve iğ biçimindedir. Ağzı öne doğru uzayabilme yeteneğinde, dişleri ince, gözleri iri, kuyruğu derin çatallıdır."
    },
    {
      "id": 8,
      "name": "kalkan",
      "detay":
          "Kalkan balığı, Scophthalmidae familyasına ait, gözleri vücudunun sol tarafında bulunan ve sağ tarafı ile denizin tabanında yatan bir yassı balık türü. Atlas Okyanusu'nun doğusunda kıyı yakınlarında, Akdenizde, Ege denizi'nde, Marmara denizi'nde ve Karadeniz'de, 20 ila 70 metre derinlikte yaşar."
    },
    {
      "id": 9,
      "name": "karides",
      "detay":
          "Karides, Avrupa denizlerinde ve Kuzey Amerika kıyılarında yaşayan, kabuklular sınıfındandır. Silindirik vücutlu, uzun duyargalıdır. Boyu 5–6 cm'dir. Vücudu kalsiyum karbonattan meydana gelen bir zırhla örtülüdür. Gövdesi eklemlidir. Geniş yüzgeçimsi kuyruğunu sallayarak geri geri yüzer."
    },
    {
      "id": 10,
      "name": "kefal",
    ...
    },
    {
      ...
      "name": "levrek",
      "detay":
          "Genellikle orta büyüklükte olan levrek, ortalama 30 ila 70 santimetre arasında uzunluğa sahiptir. Ancak daha büyük bireyler de bulunabilir. Levrek, sahip olduğu beyaz eti ile tanınır ve bu et oldukça lezzetlidir. Ağız yapısı büyüktür. Bu, levreğe avlanırken avantaj sağlar. Sırt yüzgeci oldukça belirgin ve sivri uçludur."
    },
    {
      "id": 12,
      "name": "lufer",
    ...
    },
    {
      ...
      "name": "palamut",
      "detay":
          "Palamut, genellikle sıcak ve ılık denizlerde, hem açıkta hem de kıyı bölgelerinde yaşayan kemikli balık türüdür. Oldukça büyük ve keskin dişlerle kaplı olan ağzı, torpil biçimindeki bedeninin ucundadır. Sırtlarının genellikle mavimsi rengi, yanlara doğru gidildikçe karında gümüşi beyaza dönüşür."
    },
    {
      "id": 14,
      "name": "rina",
    ...
    },
    {
      ...
      "name": "sazan",
      "detay":
          "Sazan, sazangiller familyasına adını veren tatlı su balığı. Göl ve yavaş akan derelerde bulunur. Uzun gövdeli, solucan, böcek larvaları ve bitkilerle beslenen bir dip balığıdır. 1,5 metre boyunda, 35 kg ağırlıkta olanları vardır. Ömrü 40-50 yıla kadar varabilir."
    },
    {
      "id": 16,
      "name": "tekir",
      "detay":
          "Tekir, Mullidae familyasından vücut rengi kırmızı veya pembemsi renkte olan bir balık türü. Vücut yuvarlak olup, başın altında bir çift bıyık bulunur. Büyük olan başın uzunluğu, yüksekliğinden fazladır ve baş profili eğimlidir. Birinci sırt yüzgecinde boyunca sarı ve kırmızımsı renkli bantlar bulunur."
    },
    {
      "id": 17,
      "name": "vatoz",
      "detay":
          "Bu tür balıklar ılık veya soğuk denizlerde yaşarlar. Birçok türü bulunan bu balıkların deniz dibindeki kum ve çamurlarda yaşadığı bilinir. Tatlı ve tuzlu sularda yaşayan bu tür balıklar, okyanuslarda sıklıkla karşılaşılır."
    },
    {
      "id": 18,
      "name": "cipura",
      "detay":
          "Çipura ya da çupra, Sparidae familyasına ait, Akdeniz'de yayılım gösteren balık türü. Klimatik yapıdan çipura balığına tüm Akdeniz’de rastlanmakla birlikte doğu ve güneydoğu Akdeniz ülkelerinde, Kanarya Adaları'nda, İngiltere kıyılarında, Verde Burnu'nda ve nadir olarak Karadeniz kıyılarında rastlanır."
    }
  ];
                ...
                Column(
                  children: [
                    ...
                    Text(
                      _recognitions == null
                          ? "Balık Türü"
                          : "Balık Türü: % ${double.parse(_recognitions[0]["confidence"].toString().substring(0, 3)) * 100} ${_recognitions[0]["label"].toString().split(' ')[1]}",
                      style: TextStyle(
                          fontSize: 20,
                    ...
                    v == ""
                        ? const Text("")
                        : Text(dataList.firstWhere((element) =>
                            element["name"] ==
  ...
  void saveData2() async {
    ...
    if (_adetController.text == "") {
      Fluttertoast.showToast(
          msg: "Lütfen adet giriniz", toastLength: Toast.LENGTH_LONG);
      return;
    }
